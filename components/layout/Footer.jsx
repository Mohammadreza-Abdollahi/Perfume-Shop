          ...
          <div className="flex flex-1/2 flex-col items-start justify-center gap-10 ps-44">
            <div className="flex items-center gap-7">
              ...
              <div className="flex flex-col">
                <span className="text-slate-500 text-lg">پست الکترونیک</span>
            ...
            <div className="flex items-center gap-7">
              ...
              />
              <div className="flex flex-col">
                <span className="text-slate-500 text-lg">تلفن همراه</span>
            ...
            <div className="flex items-center gap-7">
              ...
              />
              <div className="flex flex-col">
                <span className="text-slate-500 text-lg">دفتر</span>
